...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		ArrayList<Integer> numOfEdges = new ArrayList<>(getNumVertices());
		for(int i = 0; i<getNumVertices(); i++){
			numOfEdges.add(getNeighbors(i).size()+getInNeighbors(i).size());
		}
		numOfEdges.sort((e1, e2) -> -e1.compareTo(e2));
		return numOfEdges;
	}
